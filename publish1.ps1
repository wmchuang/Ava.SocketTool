...
dotnet publish -c Release -f net7.0 --self-contained true -p:PublishSingleFile=true -p:IncludeNativeLibrariesForSelfExtract=true  --runtime win-x86 -o "./publish/Ava.SocketTool (Win X86)" ./Ava.SocketTool
dotnet publish -c Release -f net7.0 --self-contained true -p:PublishSingleFile=true -p:IncludeNativeLibrariesForSelfExtract=true  --runtime win-x64 -o "./publish/Ava.SocketTool (Win X64)" ./Ava.SocketTool
dotnet publish -c Release -f net7.0 --self-contained true -p:PublishSingleFile=true -p:IncludeNativeLibrariesForSelfExtract=true  --runtime linux-x64 -o "./publish/Ava.SocketTool (Linux X64)" ./Ava.SocketTool
dotnet publish -c Release -f net7.0 --self-contained true -p:PublishSingleFile=true  --runtime osx-x64 -o "./publish/Ava.SocketTool (macOS 10.12 X64)" ./Ava.SocketTool
